					...
					<div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="side1">
								...
								<a class="dropdown-item d-flex border-bottom" href="chat.php">
				...
				<div class="container">
					<div class="row align-items-center flex-row-reverse">
						<div class="col-md-12 col-sm-12 text-center">
							 Copyright © <span id="year"></span> <a href="">NoteSwap</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="https://digvijay.rf.gd"> Digvijay </a> All rights reserved
						</div>
					</div>
				</div>
			</footer>
